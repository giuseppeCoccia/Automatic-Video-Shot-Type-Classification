...
rm ../Data/Videos/extracted_frames_plan_large/*
rm ../Data/Videos/extracted_frames_plan_americain/*
...
for video in ../Data/Videos/*.mp4; do
	...
	./run_extract_frame.sh "${video%.*}" ../Data/Videos/extracted_frames_plan_americain plan_americain
	./run_extract_frame.sh "${video%.*}" ../Data/Videos/extracted_frames_plan_large plan_large
done
